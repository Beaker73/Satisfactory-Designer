...
export const databaseContext = createContext<DatabaseData | undefined>(undefined);

export interface DatabaseProviderProps {
	database: DatabaseData,
}

export let _defaultDatabase: DatabaseAccessor | undefined;

export function defaultDatabase(): DatabaseAccessor 
{
	if(!_defaultDatabase)
		throw new Error("Default database not set");
 ...
 */
export function setDefaultDatabase(database: DatabaseAccessor) 
{
