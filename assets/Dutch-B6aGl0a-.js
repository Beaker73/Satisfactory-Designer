import { j as jsxRuntimeExports } from './index-aaN8DlWc.js';
import { N as NL } from './index-COOpmrBD.js';

/** The plugin that contains the dutch language */ const Dutch = {
    data: {
        languages: {
            nl: {
                image: ()=>/*#__PURE__*/ jsxRuntimeExports.jsx(NL, {}),
                name: "Nederlands",
                items: {
                    ironOre: {
                        name: "IJzer",
